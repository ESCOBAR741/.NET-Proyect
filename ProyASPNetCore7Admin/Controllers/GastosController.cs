...
namespace ProyASPNetCore7Admin.Controllers
{
    public class GastosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoGasto,Detalle,Descripcion,Monto,IdUsuario,FechaGasto")] Gasto gasto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoGasto,Detalle,Descripcion,Monto,IdUsuario,FechaGasto")] Gasto gasto)
        {
            if (id != gasto.Id)
            {
                return NotFound();
