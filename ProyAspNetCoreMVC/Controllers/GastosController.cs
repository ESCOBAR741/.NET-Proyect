...
using ProyAspNetCoreMVC.Models;

namespace ProyAspNetCoreMVC.Controllers
{
    public class GastosController : Controller
    {
        ...
        {
            var dbseguimientoGastosContext = _context.Gastos.Include(g => g.IdUsuarioNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdGasto,TipoGasto,Detalle,Descripcion,Monto,IdUsuario,FechaGasto")] Gasto gasto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGasto,TipoGasto,Detalle,Descripcion,Monto,IdUsuario,FechaGasto")] Gasto gasto)
        {
            if (id != gasto.IdGasto)
            {
                return NotFound();
